            ...
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="/user/home" role="button">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-left" aria-labelledby="topnav-email">
                            <a href="/user/orlogo/orlogo-burtgeh" class="dropdown-item">Шинээр орлого бүртгэх</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-ui" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="mdi mdi-buffer mr-2"></i>Тайлан
                        </a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="/sign-out" id="topnav-layout"
                            role="button">
